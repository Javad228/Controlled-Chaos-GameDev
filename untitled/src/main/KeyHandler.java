        ...
        if (code == KeyEvent.VK_E) {
            if (gp.getCurrentRoomNum() == 3) { // room.TRAPROOM no longer exists. plz change
                ...
                if (gp.getPlayer().roomSetNum == 1) {
                    Button button1 = gp.getRooms().get(5).getButtons().get(0);
                    Button button2 = gp.getRooms().get(5).getButtons().get(1);
                    Button button3 = gp.getRooms().get(5).getButtons().get(2);
                    //Button button4 = gp.getRooms().get(2).getButtons().get(3);

                    if ((gp.getPlayer().getRow() >= Button.button1Row - 1) && (gp.getPlayer().getRow() <= Button.button1Row + 1) &&
                            (gp.getPlayer().getCol() >= Button.button1Col - 1) && (gp.getPlayer().getCol() <= Button.button1Col + 1)) {
                        button1.toggle();
                    } else if ((gp.getPlayer().getRow() >= Button.button2Row - 1) && (gp.getPlayer().getRow() <= Button.button2Row + 1) &&
                            (gp.getPlayer().getCol() >= Button.button2Col - 1) && (gp.getPlayer().getCol() <= Button.button2Col + 1)) {
                        button2.toggle();
                    } else if ((gp.getPlayer().getRow() >= Button.button3Row - 1) && (gp.getPlayer().getRow() <= Button.button3Row + 1) &&
                            (gp.getPlayer().getCol() >= Button.button3Col - 1) && (gp.getPlayer().getCol() <= Button.button3Col + 1)) {
                        button3.toggle();
                    }

                    if (button1.getIsOn() && button2.getIsOn() && !button3.getIsOn()) {
                        button1.getDoorTiles().get(0).toggleDoor(DoorTile.room5DoorCol, DoorTile.room5DoorRow);
                        Audio.doorOpenAudio();
                    }
                }
