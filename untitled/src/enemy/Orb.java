...
public class Orb extends Projectile {
    ...
    public Orb(GamePanel gp, int xCoord, int yCoord, String direction, boolean isPlayerShooting, double damageMod) {
    ...
    public void getImage() {
        try {
            this.setArrowUp(ImageIO.read(getClass().getResourceAsStream("/bigWizard/orb.png")));
            this.setArrowDown(ImageIO.read(getClass().getResourceAsStream("/bigWizard/orb.png")));
            this.setArrowRight(ImageIO.read(getClass().getResourceAsStream("/bigWizard/orb.png")));
            this.setArrowLeft(ImageIO.read(getClass().getResourceAsStream("/bigWizard/orb.png")));
        } catch(IOException e) {
            e.printStackTrace();
        }
    }
