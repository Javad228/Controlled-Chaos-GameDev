...
public abstract class Entity {
     ...
     */
    public Entity(String name, CombatType type) {
        this();
        this.name = name;
        this.type = type;
    }
     ...
     * @param projectile Type of projectile generated by character
     */
    public Entity(String name, int health, int movementSpeed, int xCoord, int yCoord, int height, int width,
